...
from apps.payment.views.card import AddCardAPIView, ConfirmUserCardAPIView, DeleteUserCardAPIView, ListUserCardsAPIView, \
    GetSingleUserCardAPIView, UserCardReceiptCreateAPIView, UserCardReceiptConfirmAPIView
...
urlpatterns = [
    ...
    path("card/receipt/create/", UserCardReceiptCreateAPIView.as_view(), name="create-receipt"),
    path("card/receipt/pay/", UserCardReceiptConfirmAPIView.as_view(), name="pay-receipt"),
]
